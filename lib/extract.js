...
//
// (`node-walk` doesn't handle all the code that is valid Node.js supported
// runtimes. These helpers smooth over the differences until supported
// upstream.)
...
const walkVisitor = Object.assign({}, acornWalk.base, {
  // Supports ES `class` public, private, and static fields.
  // See: https://github.com/FormidableLabs/trace-deps/pull/64
