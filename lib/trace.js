    ...
    .all(depNames.map(async (depName) => {
      ...
      return resolve(depName, {
        ...
        packageFilter: (pkg, pkgfile) => {
          // TODO: HERE -- this isn't right. `default` condition should override `import`
          // TODO: For `default` could do both a `require: true` and `require: false`
          // field.
          ...
          //   const resolved = resolveExports.resolve(pkg, depName, {
          //     conditions: [cond],
          //     require: cond === "require",
          //     ...resolveOpts
          //   });

          //   console.log("TODO resolve.exports", {
          //     cond,
          //     resolveOpts,
          //     resolved
          //   })
