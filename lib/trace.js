      ...
      return resolve(depName, {
        ...
        packageFilter: (pkg, pkgfile) => {
          ...
          CONDITIONS.forEach((cond) => {
            ...
            const relPath = resolveExports.resolve(pkg, depName, {
              conditions: [cond],
            ...
            if (relPath) {
              ...
              const fullPath = toPosixPath(path.resolve(pkgDir, relPath));
              exportSrcs.set(fullPath, { relPath, fullPath });
            }
          });

          // TODO: REMOVE -- I'm really curious what the case is that would hit this...
