...
const _recurseDeps = async ({
  srcPaths,
  mode = "TODO_DOES_THIS_NEED_A_DEFAULT",
  depPaths = [],
  ignores = [],
  allowMissing = {},
  bailOnMissing = true,
 ...
 * @param {string}        opts.mode               Node.js import mode
...
const traceFile = async ({
  srcPath,
  mode = "TODO_DEFAULT_MODE_INFERRED_FROM_RUNTIME_OR_SOMETHING",
  ignores = [],
  allowMissing = {},
  bailOnMissing = true,
  includeSourceMaps = false,
...
const traceFiles = async ({
  srcPaths,
  mode = "TODO_DOES_THIS_NEED_A_DEFAULT_TOO",
  ignores = [],
  allowMissing = {},
  bailOnMissing = true,
  includeSourceMaps = false,
