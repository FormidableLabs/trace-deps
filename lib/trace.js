...
// TODO: Add a user condition to override specifically and replace (OR TICKET)
const CONDITIONS = [
  // Node.js conditions
    ...
    .all(depNames.map(async (depName) => {
      ...
      return resolve(depName, {
        ...
        packageFilter: (pkg, pkgfile) => {
          ...
          //   try {
          //     exportSrcs.add(resolveExports.resolve(pkg, depName, {
          //       conditions: [cond],
          //       require: cond === "require",
          //       ...resolveOpts
          //     }));
          //   } catch (e) {}
          //   // TODO: REVIEW CATCH HERE -- might need to just add name to fixtues.
          //   // TODO: But handle more generally?
          // });

          // // TODO: HERE -- logging here _causes_ test failures ???
          // console.log("TODO HERE resolve.pkgFilter", {
          //   basedir,
          //   depName,
          //   pkgfile,
          //   exportSrcs
          ...
          if (pkgPaths.length > 1) {
            console.log("TODO HERE pkgPaths", { pkgPaths });
            throw new Error("TODO: REMOVE - DO WE EVER HIT MULTIPLE PKG PATHS?")
          }
      ...
      // TODO: Instead of getting just `depPath`, I think we can now get resolved `depPaths` from
      // the extra imports stuff.
      // - [ ] Put it in a set / make unique
      // - [ ] Then iterate for each of these.
      // - [ ] Need to separately check extra exports exist on disk and throw `MODULE_NOT_FOUND`?
