 ...
 * @param {boolean}       opts.sourceMaps       include source map paths in output
...
const traceFile = async ({
  ...
  const onComment = sourceMaps ? extractSourceMapPaths({ basedir, sourceMapPaths }) : undefined;
  ...
  // TODO: HERE -- DO NEXT THINGS WITH SOURCE MAP PATHS!!!
  if (sourceMapPath) {
    // eslint-disable-next-line no-console
    console.log("TODO HAVE MAP", { sourceMapPath });
  }
